...
import { mockUsers, mockWorkflows } from "@/lib/mock-data"
        ...
        <div className="space-y-6">
          <Card>
            ...
            <CardContent className="text-sm text-muted-foreground space-y-2">
              <p>• Use clear, actionable titles</p>
              <p>• Add detailed descriptions for context</p>
              <p>• Set realistic due dates</p>
              <p>• Assign tasks to the right team members</p>
              <p>• Use tags for easy filtering</p>
            </CardContent>
          </Card>
        </div>
      </div>
