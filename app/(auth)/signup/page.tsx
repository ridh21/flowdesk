  ...
  return (
    <Card className="border-0 shadow-lg">
      <CardHeader className="space-y-1 text-center">
        ...
        <CardDescription>
          Enter your details to get started with FlowDesk
        </CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
